...
export const assistaAskSchema = z.enum(assistaAsks)

export type AssistaAsk = z.infer<typeof assistaAskSchema>
 ...
 * - `assistaignore_error`: Error related to .assistaignore file processing
...
export const assistaSaySchema = z.enum(assistaSays)

export type AssistaSay = z.infer<typeof assistaSaySchema>
...
export const assistaMessageSchema = z.object({
	ts: z.number(),
	type: z.union([z.literal("ask"), z.literal("say")]),
	ask: assistaAskSchema.optional(),
	say: assistaSaySchema.optional(),
	text: z.string().optional(),
...
export type AssistaMessage = z.infer<typeof assistaMessageSchema>
