...
This guide explains how to add new coding exercises to the Cybrosys Assista evals system. The evals system is a distributed evaluation platform that runs AI coding tasks in isolated VS Code environments to test AI coding capabilities across multiple programming languages.
...
- **Exercises Repository**: [`Cybrosys-Assista-Evals`](https://github.com/CybrosysAssistaInc/Cybrosys-Assista-Evals) - Contains all exercise definitions
...
TL;DR - Here's a pull request that adds a new JavaScript eval: https://github.com/CybrosysAssistaInc/Cybrosys-Assista-Evals/pull/3
...
1. **Clone the evals repository**:
    ...
    ```bash
    git clone https://github.com/CybrosysAssistaInc/Cybrosys-Assista-Evals.git evals
    cd evals
    ```
...
version = "0.1.0"
description = "Python exercises for Cybrosys Assista evals"
requires-python = ">=3.9"
dependencies = [
    "pytest>=8.3.5",
]
...
Adding a new programming language requires changes to both the evals repository and the main Cybrosys Assista repository.
