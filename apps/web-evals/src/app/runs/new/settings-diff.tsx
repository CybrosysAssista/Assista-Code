...
import { type Keys, type CybrosysAssistaSettings, GLOBAL_SETTINGS_KEYS, PROVIDER_SETTINGS_KEYS } from "@cybrosys-assista/types"

import { cn } from "@/lib/utils"

export const CYBROSYS_ASSISTA_SETTINGS_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS] as Keys<CybrosysAssistaSettings>[]
...
export function SettingsDiff({
	...
	return (
		<div className={cn("grid grid-cols-3 gap-2 text-sm p-2", className)} {...props}>
			...
			{CYBROSYS_ASSISTA_SETTINGS_KEYS.map((key) => {
