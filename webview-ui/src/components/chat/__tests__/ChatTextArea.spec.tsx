...
import { defaultModeSlug } from "@assista/modes"
		...
		describe("prompt history navigation", () => {
			...
			beforeEach(() => {
				;(useExtensionState as ReturnType<typeof vi.fn>).mockReturnValue({
					...
					taskHistory: [],
					assistaMessages: mockAssistaMessages,
					cwd: "/test/workspace",
				})
			})
			...
			it("should filter history by current workspace", () => {
				...
				;(useExtensionState as ReturnType<typeof vi.fn>).mockReturnValue({
					...
					taskHistory: [],
					assistaMessages: mixedAssistaMessages,
					cwd: "/test/workspace",
				})
			...
			it("should ignore empty or whitespace-only messages", () => {
				const assistaMessagesWithEmpty = [
				...
				;(useExtensionState as ReturnType<typeof vi.fn>).mockReturnValue({
					...
					taskHistory: [],
					assistaMessages: assistaMessagesWithEmpty,
					cwd: "/test/workspace",
				})
			...
			it("should use task history (oldest first) when no conversation messages exist", () => {
				...
				;(useExtensionState as ReturnType<typeof vi.fn>).mockReturnValue({
					...
					assistaMessages: [], // No conversation messages
					cwd: "/test/workspace",
				})
