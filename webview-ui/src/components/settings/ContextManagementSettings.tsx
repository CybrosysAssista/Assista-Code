	...
	return (
		<div className={cn("flex flex-col gap-2", className)} {...props}>
			...
			<Section>
				...
				<div>
					<VSCodeCheckbox
						checked={showAssistaIgnoredFiles}
						onChange={(e: any) => setCachedStateField("showAssistaIgnoredFiles", e.target.checked)}
						data-testid="show-assistaignored-files-checkbox">
						<label className="block font-medium mb-1">
							{t("settings:contextManagement.assistaignore.label")}
						</label>
					</VSCodeCheckbox>
					<div className="text-vscode-descriptionForeground text-sm mt-1 mb-3">
						{t("settings:contextManagement.assistaignore.description")}
					</div>
				</div>
