...
describe("ContextManagementSettings", () => {
	...
	it("renders all controls", () => {
		...
		// Show .assistaignore'd files
		const showAssistaIgnoredFilesCheckbox = screen.getByTestId("show-assistaignored-files-checkbox")
		expect(showAssistaIgnoredFilesCheckbox).toBeInTheDocument()
		expect(screen.getByTestId("show-assistaignored-files-checkbox")).not.toBeChecked()
	})
	...
	it("updates show assistaignored files setting", () => {
		render(<ContextManagementSettings {...defaultProps} />)

		const checkbox = screen.getByTestId("show-assistaignored-files-checkbox")
		fireEvent.click(checkbox)

		expect(defaultProps.setCachedStateField).toHaveBeenCalledWith("showAssistaIgnoredFiles", true)
	})
	...
	describe("Edge cases and validation", () => {
		...
		it("handles undefined optional props gracefully", () => {
			const propsWithUndefined = {
				...defaultProps,
				showAssistaIgnoredFiles: undefined,
	...
	describe("Accessibility", () => {
		it("has proper labels and descriptions", () => {
			...
			expect(screen.getByText("settings:contextManagement.assistaignore.label")).toBeInTheDocument()
			...
			expect(screen.getByText("settings:contextManagement.assistaignore.description")).toBeInTheDocument()
		})
		...
		it("has proper test ids for all interactive elements", () => {
			...
			expect(screen.getByTestId("show-assistaignored-files-checkbox")).toBeInTheDocument()
