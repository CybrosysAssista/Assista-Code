...
export const DIFF_VIEW_URI_SCHEME = "assista-diff"
export const DIFF_VIEW_LABEL_CHANGES = "Original ↔ Assista's Changes"

// TODO: https://github.com/assista/assista/pull/3354
export class DiffViewProvider {
	...
	async open(relPath: string): Promise<void> {
		...
		// after editing to see if assista needs to fix anything.
	...
	async saveChanges(): Promise<{
		...
		// Since these are new problems resulting from Assista's edit, we know they're
		// directly related to the work he's doing. This eliminates the risk of Assista
		// going off-task or getting distracted by unrelated issues, which was a problem
		// with the previous auto-debug approach. Some users' machines may be slow to
		// update diagnostics, so this approach provides a good balance between automation
		// and avoiding potential issues where Assista might get stuck in loops due to
		// outdated problem information. If no new problems show up by the time the user
		// accepts the changes, they can always debug later using the '@problems' mention.
		// This way, Assista only becomes aware of new problems resulting from his edits
