...
import type { AssistaTerminalCallbacks, AssistaTerminalProcessResultPromise } from "./types"
...
export class Terminal extends BaseTerminal {
	...
	constructor(id: number, terminal: vscode.Terminal | undefined, cwd: string) {
		...
		this.terminal = terminal ?? vscode.window.createTerminal({ cwd, name: "Cybrosys Assista", iconPath, env })
	...
	public override runCommand(command: string, callbacks: AssistaTerminalCallbacks): AssistaTerminalProcessResultPromise {
