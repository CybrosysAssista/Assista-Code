...
import type { AssistaTerminalProcess, AssistaTerminalProcessEvents, ExitCodeDetails } from "./types"

export abstract class BaseTerminalProcess extends EventEmitter<AssistaTerminalProcessEvents> implements AssistaTerminalProcess {
	...
	// of before sending request to Cybrosys Assista.
