import { AssistaMessage } from "@cybrosys-assista/types"
import { safeJsonParse } from "./safeJsonParse"

export const COMMAND_OUTPUT_STRING = "Output:"

/**
 * Combines sequences of command and command_output messages in an array of AssistaMessages.
 * Also combines sequences of use_mcp_server and mcp_server_response messages.
 *
 * This function processes an array of AssistaMessages objects, looking for sequences
 ...
 * @returns A new array of AssistaMessage objects with command and MCP sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: AssistaMessage[]): AssistaMessage[] {
	const combinedMessages = new Map<number, AssistaMessage>()
