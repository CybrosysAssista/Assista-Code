...
import type { ModeConfig, PromptComponent } from "@cybrosys-assista/types"
	...
	describe("debug mode", () => {
		it("is configured correctly", () => {
			...
			expect(debugMode).toMatchObject({
				...
				name: "🪲 Debug",
				roleDefinition:
					"You are Assista, an expert software debugger specializing in systematic problem diagnosis and resolution.",
