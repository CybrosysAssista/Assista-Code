...
/**
 * Controls write access to Assista configuration files by enforcing protection patterns.
 * Prevents auto-approved modifications to sensitive Assista configuration files.
 */
export class AssistaProtectedController {
	private cwd: string
	private ignoreInstance: Ignore

	// Predefined list of protected Assista configuration patterns
	private static readonly PROTECTED_PATTERNS = [
		...
		".assistarules*",
		".assista/**",
		".assistaprotected", // For future use
	]
	...
	constructor(cwd: string) {
		...
		this.ignoreInstance.add(AssistaProtectedController.PROTECTED_PATTERNS)
	}
	...
	getProtectionMessage(): string {
		return "This is a Assista configuration file and requires approval for modifications"
	}
	...
	getInstructions(): string {
		const patterns = AssistaProtectedController.PROTECTED_PATTERNS.join(", ")
		return `# Protected Files\n\n(The following Assista configuration file patterns are write-protected and always require approval for modifications, regardless of autoapproval settings. When using list_files, you'll notice a ${SHIELD_SYMBOL} next to files that are write-protected.)\n\nProtected patterns: ${patterns}`
	}
	...
	static getProtectedPatterns(): readonly string[] {
		return AssistaProtectedController.PROTECTED_PATTERNS
	}
}
