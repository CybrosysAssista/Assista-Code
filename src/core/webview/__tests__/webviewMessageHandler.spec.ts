...
import type { AssistaProvider } from "../AssistaProvider"
import { getModels } from "../../../api/providers/fetchers/modelCache"
import type { ModelRecord } from "../../../shared/api"

const mockGetModels = getModels as Mock<typeof getModels>

// Mock AssistaProvider
const mockAssistaProvider = {
	getState: vi.fn(),
	postMessageToWebview: vi.fn(),
} as unknown as AssistaProvider

describe("webviewMessageHandler - requestRouterModels", () => {
	beforeEach(() => {
		vi.clearAllMocks()
		mockAssistaProvider.getState = vi.fn().mockResolvedValue({
			apiConfiguration: {
	...
	it("successfully fetches models from all providers", async () => {
		...
		await webviewMessageHandler(mockAssistaProvider, {
		...
		expect(mockAssistaProvider.postMessageToWebview).toHaveBeenCalledWith({
			type: "routerModels",
			routerModels: {
