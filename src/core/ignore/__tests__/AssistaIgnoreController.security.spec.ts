// npx vitest core/ignore/__tests__/AssistaIgnoreController.security.spec.ts

import type { Mock } from "vitest"

import { AssistaIgnoreController } from "../AssistaIgnoreController"
...
describe("AssistaIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .assistaignore to exist with some patterns
