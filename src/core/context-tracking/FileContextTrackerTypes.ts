...
export const recordSourceSchema = z.enum(["read_tool", "user_edited", "assista_edited", "file_mentioned"])
...
export const fileMetadataEntrySchema = z.object({
	...
	assista_read_date: z.number().nullable(),
	assista_edit_date: z.number().nullable(),
