...
export async function regexSearchFiles(
	...
	// Filter results using AssistaIgnoreController if provided
	const filteredResults = assistaIgnoreController
		? results.filter((result) => assistaIgnoreController.validateAccess(result.file))
		: results
