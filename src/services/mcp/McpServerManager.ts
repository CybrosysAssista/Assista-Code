...
export class McpServerManager {
	...
	private static providers: Set<AssistaProvider> = new Set()
	 ...
	 */
	static async getInstance(context: vscode.ExtensionContext, provider: AssistaProvider): Promise<McpHub> {
	 ...
	 */
	static unregisterProvider(provider: AssistaProvider): void {
